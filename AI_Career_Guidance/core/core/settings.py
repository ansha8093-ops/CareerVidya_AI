...
SECRET_KEY = 'django-insecure-=inh##wzrijvglx4ak3a&%pkp1s%(7a$mlq+)wpxix(dxe%8&y'
...
if DATABASE_URL:
    ...
    # fallback local Postgres ya SQLite
    DATABASES = {
        'default': {
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "accounts" / "static",   # accounts app ke static folder ko add karo
]
